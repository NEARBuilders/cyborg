/**
 * FastData Protocol Builders
 * Copied from https://github.com/MultiAgency/fastdata-social
 *
 * Builds KV pairs for various social operations using the FastData protocol.
 */
